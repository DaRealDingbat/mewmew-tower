...
public interface ChoiceContext extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ChoiceContext {
        ...
        public static ChoiceContext asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ChoiceContext)) {
                return new Proxy(obj);
            }
            return (ChoiceContext) iin;
        }
        ...
        private static class Proxy implements ChoiceContext {
