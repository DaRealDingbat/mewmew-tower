...
public interface ExceptionResult extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ExceptionResult {
        ...
        public static ExceptionResult asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ExceptionResult)) {
                return new Proxy(obj);
            }
            return (ExceptionResult) iin;
        }
        ...
        private static class Proxy implements ExceptionResult {
